...
int main(int argc, char** argv){
    ...
    std::cout << "num_chucks: " << data->num_chunks << std::endl;
    std::cout << "chunk_size: " << data->chunk_size << std::endl;
    std::cout << "storage size: " << storage_size << "kb " << storage_size * p.f_a << std::endl;
    std::cout << "possible skips: " << data->num_chunks * queries->num_queries << std::endl;
